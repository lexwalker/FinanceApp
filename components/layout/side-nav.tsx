    ...
    <>
      <aside className="hidden min-h-screen w-72 shrink-0 flex-col border-r border-white/60 bg-white/55 px-6 py-8 backdrop-blur-2xl lg:flex">
        <div className="rounded-[28px] bg-slate-950 px-5 py-5 text-white shadow-[0_20px_60px_-28px_rgba(15,23,42,0.7)]">
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-[-0.05em]">Финансы без шума</h2>
          <p className="mt-2 text-sm leading-6 text-white/70">
            Личный cashflow dashboard, который показывает баланс, аналитику и лимиты за секунды.
          </p>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-slate-950 text-white shadow-[0_18px_30px_-22px_rgba(15,23,42,0.75)]"
        ...
        <Link
          ...
          className="mt-auto inline-flex items-center justify-center gap-2 rounded-2xl bg-[linear-gradient(135deg,#0f172a,#1d4ed8)] px-4 py-3 text-sm font-semibold text-white shadow-[0_18px_30px_-18px_rgba(29,78,216,0.55)] transition hover:translate-y-[-1px]"
        >
